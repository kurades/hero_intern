...
export const getHeroes = createAction('[Hero page] Get Heroes');
...
export const getTopHeroes = createAction('[Hero page] Get Top Heroes');
...
export const addTag = createAction('[Tag] add tag', props<{ name: string }>());
